...
Unless otherwise stated, the "advection" term in this paper indicates the sum of the terms in Eq.~\ref{eq:advtend}.
...
This shalow layer also contained the largest diurnally-averaged radiative heating tendencies found anywhere in the domain (Fig.~\ref{fig:fulltrop}c).
