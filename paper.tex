...
The potential temperature tendency can be partitioned into ### "budget variables," which are output directly by the model every two minutes:

POTENTIAL TEMPERATURE TENDENCY EQUATION
