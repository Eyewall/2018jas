...
INCLUDE IN THIS INTRODUCTION DAN STERN'S POTENTIAL TEMPERATURE BUDGET PAPERS
...
The initial temperature and humidity field was horizontally-homogeneous and determined by averaging all Climate Forecast System Reanalysis (CFSR) grid points within 1000 km of Patricia's center of circulation at 18 UTC 21 October 2015.
...
To compute $N^2$, CM1 uses Eq.\ref{eq:n2moist} in saturated environments and Eq. \ref{eq:n2dry} in sub-saturated environments. For simplicity, however, only Eq. \ref{eq:n2dry} will be used for the budget computations herein\footnote{The validity of this approximation will be substantiated later in this section.}.
...
Destabilization was particularly pronounced over the developing eye, where the time-mean cold-point tropopause height increased by up to one km compared to the previous day.
Over the developing eyewall and rainband regions, meanwhile, the tropopause height remained nearly constant.
During the third day of the simulation (Fig.~\ref{fig:n2-24hr-avgs}c), static stability over the eye continued to decrease, and the cold-point tropopause height rose to nearly 20 km over the eye.
The tropopause sloped sharply downward outside of the 20-km radius, reaching a minimum altitude of 16.4 km only 45 km from the storm center.
...
At larger radii, static stability began to increase in the layer immediately overlying the cold-point tropopause.
...
Over the next 24 hours (Fig.~\ref{fig:n2-24hr-avgs}d), as the storm's maximum 10-m wind speed remained quasi-steady near 80 m s\textsuperscript{-1} (Fig.~\ref{fig:vmax+pmin}), the tropopause-layer static stability continued to increase.
%As this stable layer strengthened, its altitude rose slightly, which corresponded to a slight increase in tropopause height outside of the eyewall during this period.
...
Within the eye, the layer between 16 and 19 km continued to destabilize, and the cold-point tropopause height increased to a level above 21.5 km.
...
%FIGURE 2%
\begin{figure}[ht]
\centerline{\includegraphics[width=33pc]{figures/mod+bud+res.png}}
