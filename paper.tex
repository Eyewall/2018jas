...
These results support the hypothesized role of turbulence in setting the outflow-layer $\theta$ stratification in \cite{EmanuelRotunno2011}, although more experiments with different turbulence parameterizations are needed to prove this conclusively.
