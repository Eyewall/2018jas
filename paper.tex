...
Outside of the eye, the upper-tropospheric outflow layer exports high potential temperature ($\theta$) air from the eyewall to large radii in the upper troposphere.
...
The warming of the upper troposophere by these advective and diffusive processes could decrease the vertical $\theta$ gradient, thereby contributing to a decrease in static stability near the tropoopause within the eye.
