...
\authors{Patrick Duran\correspondingauthor{Patrick Duran, University of Alabama in Huntsville, 320 Sparkman Dr. NW, Huntsville, AL 35805.}\thanks{Current affiliation: Earth System Science Center, University of Alabama in Huntsville} and John Molinari}
...
\indent A budget analysis reveals that the advection term, which includes differential advection of potential temperature ($\theta$) and direct advection of static stability, is important throughout the upper troposphere and lower stratosphere.
...
%These turbulent and radiative processes combine to play an important role in the development of the strong stable layer immediately above the cold-point tropopause during RI.
...
%\abstract{Large changes in tropopause-layer static stability are examined during the rapid intensification (RI) of a tropical cyclone (TC) in an idealized, axisymmetric simulation.
...
%Outside of the eye, the upper-tropospheric outflow layer exports high-$\theta$ air from the eyewall to large radii in the upper troposphere.
%This increase in $\theta$ forces stabilization below the outflow jet and destabilization above.
%Vertical wind shear above and below the outflow maximum induces vertical gradients of turbulence, which also modify the vertical stability profile.
%Meanwhile, radiative cooling tendencies at the top of the cirrus canopy generally act to destabilize the upper troposphere and stabilize the lower stratosphere.
%These turbulent and radiative processes combine to play an important role in the development of the strong stable layer immediately above the cold-point tropopause during RI.}
%The results suggest that turbulence and radiation, alongside advection, play fundamental roles in the upper-level static stability evolution of TCs.}
...
Although hurricanes simulated in an axisymmetric framework tend to be more intense than those observed in nature, the intensity evolution of this simulation matches reasonably well with that observed in Hurricane Patricia\footnote{Although the intensities of the storms are comparable, the simplifications inherent to this modeling framework --- particularly axisymmetry and a lack of atmosphere--ocean coupling --- mean that the processes contributing to intensification probably are quite different.}.
...
Other processes, such as the precipitaton of ice particles, must have caused this lowering of the cirrus canopy.
  ...
  \subsubsection{Sensitivity to cloud-radiative forcing}
...
The intensity evolution of this simulation (Fig. \ref{fig:vmax-norad}, blue line) compares well with that of the simulation described in Section 2 (Fig. \ref{fig:vmax-norad}, red line), except the storm without cloud-radiative forcing took longer to begin its RI period.
Twenty-four-hour averages of $N^2$ reveal a similar overall evolution in the two simulations (compare Figs. \ref{fig:n2-24hr-avgs},\ref{fig:n2-norad}), except the lower-stratospheric $N^2$ maximum does not become as strong in the simulation without cloud-radiative forcing.
The magnitude of the sum of the advection and turbulence terms immediately surrounding the tropopause in this simulation (Fig. \ref{fig:budgetterms-norad}e) is not as large as that in the full-radiation simulation (Fig. \ref{fig:stab-48-72}e).
...
The smaller turbulence and advective tendencies, combined with the near-zero radiative heating tendencies (Fig. \ref{fig:budgetterms-norad}d), leads to a smaller lower-stratospheric stabilization tendency (compare Figs. \ref{fig:stab-48-72}a,\ref{fig:budgetterms-norad}a).
...
\centerline{\includegraphics[width=27pc]{run12+run13-vmax.png}}
   \caption{Maximum 10-m wind speed (m s\textsuperscript{-1}) for (red) the simulation described in Section 2, and (blue) an identical simulation except condensate is not permitted to interact with radiation.}
...
\centerline{\includegraphics[width=39pc]{n2-norad.png}}
   \caption{As in Fig. \ref{fig:n2-24hr-avgs}, but for the simulation in which radiation is not permitted to interact with condensate.}
\label{fig:n2-norad}
\end{figure*}
...
\centerline{\includegraphics[width=39pc]{budgetterms-norad.png}}
   \caption{As in Fig. \ref{fig:stab-48-72}, but for the simulation in which radiation is not permitted to interact with condensate.}
