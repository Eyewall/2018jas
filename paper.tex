...
The static stability can be expressed as the squared Brunt V{\"a}is{\"a}l{\"a} frequency:
   ...
   \end{equation}
In the tropopause layer, $q_s$, $\frac{\partial q_s}{\partial T}$, and $\frac{\partial q_t}{\partial z}$ are small. Assuming that these quantities are zero, Eq. \ref{eq:n2moist} reduces to:
