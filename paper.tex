...
Within most of this region, advection provided strong forcing for stabilization, but this forcing was outweighed by the negative $N^@$ tendencies induced by a combination of vertical turbulence and radiation.
...
The slight downward slope with radius of the $\theta$ surfaces near the tropopause (meaning that $\theta$ increases with radius) implies that the outflow in this layer locally acted to decrease $\theta$.
