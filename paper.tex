...
\abstract{Idealized simulations of an intense axisymmetric tropical cyclone (TC) reveal considerable changes in the tropopause-layer static stability during rapid intensification (RI).
During RI, static stability near the tropopause decreased over the eye.
This destabilization was associated with a rise in the cold-point tropopause height by up to 4 km at the storm center.
Outside of the eye, meanwhile, the cold-point tropopause remained near its initial level, and the static stability increased considerably in the layer immediately above it.
These results are consistent with recent observations collected during the RI of Hurricane Patricia (2015).

A static stability budget analysis reveals that horizontal and vertical advection both contribute to the static stability tendencies at all times throughout the upper troposphere and lower stratosphere.
Advection is particularly important within the eye, where is acts to destabilize the layer near and above the cold-point tropopause.
Outside of the eye, a strong radial-vertical circulation develops during RI, with outflow below the tropopause and inflow above.
Turbulence induced by strong vertical wind shear above and below the upper-tropospheric outflow maximum provides forcing for both stabilization and destabilization in the tropopause layer.
Meanwhile, as organized convection reaches the tropopause, radiative heating tendencies at the top of the cirrus canopy act to destabilize the upper troposphere and stabilize the lower stratosphere.
This combination of turbulent mixing and radiative heating plays an important role in the development of the strong stable layer immediately above the cold-point tropopause.

The resuts suggest that turbulence and radiation both play fundamental roles in the upper-level static stability evolution of TCs.
